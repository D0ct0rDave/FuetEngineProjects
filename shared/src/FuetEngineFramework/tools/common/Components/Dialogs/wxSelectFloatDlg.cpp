...
void wxSelectFloatDlg::CreateGUIControls()
{
	...
	WxButton2 = new wxButton(this, ID_WXBUTTON2, wxT("OK"), wxPoint(120, 48), wxSize(89, 33), 0, wxDefaultValidator, wxT("WxButton2"));

	WxButton1 = new wxButton(this, ID_WXBUTTON1, wxT("Cancel"), wxPoint(16, 48), wxSize(97, 33), 0, wxDefaultValidator, wxT("WxButton1"));
