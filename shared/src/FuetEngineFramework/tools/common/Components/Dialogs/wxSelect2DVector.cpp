...
void wxSelect2DVector::CreateGUIControls()
{
	...
	WxButton1 = new wxButton(this, ID_WXBUTTON1, wxT("Cancel"), wxPoint(198, 69), wxSize(97, 33), 0, wxDefaultValidator, wxT("WxButton1"));

	WxButton2 = new wxButton(this, ID_WXBUTTON2, wxT("OK"), wxPoint(34, 69), wxSize(89, 33), 0, wxDefaultValidator, wxT("WxButton2"));
