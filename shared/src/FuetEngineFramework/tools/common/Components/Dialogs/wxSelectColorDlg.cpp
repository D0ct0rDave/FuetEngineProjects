...
void wxSelectColorDlg::CreateGUIControls()
{
	...
	WxStaticText8 = new wxStaticText(this, ID_WXSTATICTEXT8, wxT("Alpha:"), wxPoint(97, 41), wxDefaultSize, 0, wxT("WxStaticText8"));

	WxStaticText7 = new wxStaticText(this, ID_WXSTATICTEXT7, wxT("Color:"), wxPoint(17, 41), wxDefaultSize, 0, wxT("WxStaticText7"));

	WxButton2 = new wxButton(this, ID_WXBUTTON2, wxT("Cancel"), wxPoint(15, 90), wxSize(97, 33), 0, wxDefaultValidator, wxT("WxButton2"));

	WxButton1 = new wxButton(this, ID_WXBUTTON1, wxT("Ok"), wxPoint(234, 91), wxSize(97, 33), 0, wxDefaultValidator, wxT("WxButton1"));

	sldAlpha = new wxSlider(this, ID_SLDALPHA, 0, 0, 255, wxPoint(129, 22), wxSize(201, 40), wxSL_HORIZONTAL | wxSL_AUTOTICKS | wxSL_LABELS | wxSL_BOTH | wxSL_SELRANGE , wxDefaultValidator, wxT("sldAlpha"));
