...
void wxGradientButton::SetColour(wxColour value)
{
	wxColour oBottomStart(value.Red()>>1,value.Green()>>1,value.Blue()>>1,value.Alpha());
	wxColour oTopEnd(value.Red()<<1,value.Green()<<1,value.Blue()<<1,value.Alpha());

	SetGradientTopStartColour(value);
    SetGradientTopEndColour(*wxWHITE);
    SetGradientBottomStartColour(oBottomStart);
    SetGradientBottomEndColour(value);
    
    SetPressedColourTop(oBottomStart);
    SetPressedColourBottom(value);
}