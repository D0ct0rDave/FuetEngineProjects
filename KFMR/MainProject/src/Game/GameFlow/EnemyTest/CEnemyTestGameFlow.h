 ...
 */
//-----------------------------------------------------------------------------
#ifndef CEnemyTestGameFlowH
#define CEnemyTestGameFlowH
//-----------------------------------------------------------------------------
#include <FuetEngine.h>
#include "FuetEngineExt.h"
#include "Game/GameFlow/CGameFlow.h"
//-----------------------------------------------------------------------------
class CEnemyTestGameFlow : public CGameFlow
{
	public:

		/// Default constructor of the level game flow.		
		CEnemyTestGameFlow(uint _uiSkill);

		/// Specific destructor for this class.
		virtual ~CEnemyTestGameFlow();
