 ...
 */
//-----------------------------------------------------------------------------
#ifndef CLevel1AEnemySpawnerH
#define CLevel1AEnemySpawnerH
//-----------------------------------------------------------------------------
...
class CSimpleEnemy;
//-----------------------------------------------------------------------------
class CLevel1AEnemySpawner : public CEnemySpawner
{
	public:

		///
		CLevel1AEnemySpawner(uint _uiSkill = 0);
		
		///
		~CLevel1AEnemySpawner();
