 ...
 */
//-----------------------------------------------------------------------------
#ifndef CLevel2BEnemySpawnerH
#define CLevel2BEnemySpawnerH
//-----------------------------------------------------------------------------
...
class CSimpleEnemy;
//-----------------------------------------------------------------------------
class CLevel2BEnemySpawner : public CEnemySpawner
{
	public:

		///
		CLevel2BEnemySpawner(uint _uiSkill = 0);
		
		///
		~CLevel2BEnemySpawner();
