...
//-----------------------------------------------------------------------------
CLevel1BonusThrownObject::CLevel1BonusThrownObject()
{
	SetSpeed(BONUS_THROWN_OBJ_SPEED);
}
//-----------------------------------------------------------------------------
void CLevel1BonusThrownObject::Init(bool _bIsGood, int _iIndex)
{
	m_bIsGood = _bIsGood;
...
//-----------------------------------------------------------------------------
void CLevel1BonusThrownObject::Update(FEReal _rDeltaT)
{
...
//-----------------------------------------------------------------------------
void CLevel1BonusThrownObject::Kill()
{
