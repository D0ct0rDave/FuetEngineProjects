 ...
 */
//-----------------------------------------------------------------------------
#ifndef CLevel1BonusGameFlowH
#define CLevel1BonusGameFlowH
//-----------------------------------------------------------------------------
#include <FuetEngine.h>
#include "FuetEngineExt.h"
#include "Game/GameFlow/CGameFlow.h"
//-----------------------------------------------------------------------------
class CLevel1BonusGameFlow : public CGameFlow
{
	public:

		/// Default constructor of the level game flow.		
		CLevel1BonusGameFlow(uint _uiSkill);

		/// Specific destructor for this class.
		virtual ~CLevel1BonusGameFlow();
