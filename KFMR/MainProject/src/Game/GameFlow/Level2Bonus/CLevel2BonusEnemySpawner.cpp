...
//-----------------------------------------------------------------------------
CLevel2BonusEnemySpawner::CLevel2BonusEnemySpawner(uint _uiSkill)
{
...
//-----------------------------------------------------------------------------
CLevel2BonusEnemySpawner::~CLevel2BonusEnemySpawner()
{
}
//-----------------------------------------------------------------------------
void CLevel2BonusEnemySpawner::Reset()
{
    m_rTime = 0;
	m_bStarted = false;
	m_uiLivingEnts = 0;
...
//-----------------------------------------------------------------------------
void CLevel2BonusEnemySpawner::SpawnObject(bool _bGood, bool _bLeft, bool _bUp)
{
	m_uiLivingEnts++;
...
//-----------------------------------------------------------------------------
void CLevel2BonusEnemySpawner::Update(FEReal _rDeltaT)
{
	m_rTime += _rDeltaT;
...
//-----------------------------------------------------------------------------
void CLevel2BonusEnemySpawner::NotifyDeath(CEntity* _poEnt)
{
	m_uiLivingEnts--;
